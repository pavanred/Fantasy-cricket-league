<?php
	...
	*/
	...
	//Create league
	$lang = array_merge($lang,array(
		"CREATE_LEAGUE_SUCCESS"				    => "Private league successfully created",		
		"JOIN_LEAGUE_SUCCESS"				    => "Joined private league successfully",	
		"LEAGUE_USER_CHAR_LIMIT"				=> "Your league name must be no fewer than %m1% characters or greater than %m2%",	
		"ADD_LEAGUE_ERROR"						=> "Error - League creation unsuccessful",	
		"JOIN_LEAGUE_ERROR"						=> "Error - League joining unsuccessful",
		"HOF_ERROR"						    => "Error - loading leader board unsuccessful",		
		"TEAM_STATS_ERROR"                   => "Error fetching team stats",
		"CREATE_TEAM_SUCCESS"				 => "New team successfully created",	
	));
?>